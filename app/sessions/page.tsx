  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <span className="text-gray-600">My Sessions</span>
            </div>
            <Button asChild>
      ...
      <main className="container mx-auto px-6 py-8">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-2">My Learning Sessions</h2>
          <p className="text-gray-600">Manage your ongoing and completed peer learning sessions.</p>
        </div>

        <div className="space-y-8">
          {/* Pending Sessions */}
          <section>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Pending Sessions ({pendingSessions.length})</h3>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <div className="text-sm text-gray-600">
                          AI Match Score: {Math.round((session.ai_match_score || 0) * 100)}%
                        </div>
          ...
          {/* Active Sessions */}
          <section>
            <h3 className="text-xl font-semibold text-gray-900 mb-4">Active Sessions ({activeSessions.length})</h3>
