      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-6 p-4 bg-blue-50 rounded-lg">
            <div className="flex items-center justify-between">
              <div>
                <h4 className="font-medium text-blue-900">AI Match Confidence Score</h4>
                <p className="text-sm text-blue-700">
                  Based on skill overlap (40%), experience compatibility (25%), availability alignment (20%), and
        ...
        <Card className="border-yellow-200 bg-yellow-50">
          <CardContent className="py-4">
            <p className="text-xs text-yellow-800">
              Debug: Status={session.status}, ShowReview={showReviewForm.toString()}, HasReviewed=
              {hasReviewed.toString()}
            </p>
          </CardContent>
        </Card>
      )}
